...
load_path_ori = "data_save/light_data_5.21/";
...
for bias = bias_begin : bias_step :bias_end
    save_path = "data_save/light_data_5.21/result1/cal_nmse/v"+ver+"/bias"+bias;
    ...
    for amp_loop = 1:length(amp_scope)       
        ...
        load_path = load_path_ori + "/data/10M/amp"+amp+"/bias"+bias+"/mat";
        load_data_mmse
