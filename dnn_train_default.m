function [ ] = dnn_train_default(train_time, savePath_mat, xTrain, yTrain, lgraph, options, test_num,...
    ...
    if train_time<=1
        ...
        net = trainNetwork(xTrain,yTrain,net_layers,options);
        save(net_path+"/net.mat",'net');  % Save the trained network
